...
import './screen.css';
import { BookFilled,PieChartOutlined,CalculatorFilled} from '@ant-design/icons';
      ...
      <Router>
        ...
        <Header className="header" style={{ height: "100px" }}>
            <div className="headertext">
              <label><CalculatorFilled  style={{fontSize:"50px", marginRight:"50px"}}/>Numerical Method</label>
            </div>
          </Header>
          <Layout>
          <Sider width={335} style={{ background: "#fff" }}>
              <Menu
                mode="inline"
                style={{ height: '90vh', borderRight: 0, backgroundColor: "#F37325", overflowY: "scroll" }}
                theme="light"
              >
            ...
            <Layout style={{ padding: '25px 25px' }}>
              <Content style={{ padding: 100, margin: 0, minHeight: 280, }}>
                <Switch>
                  {/* Root of Equation */}
